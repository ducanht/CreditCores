...
export const api = {
  ...
  getDebitBatchDetails: (maDot, forceFresh = false) => sendRequest('getDebitBatchDetails', { maDot }, 'GET', !forceFresh),
  createDebitBatch: (data) => sendRequest('createDebitBatch', data, 'POST'),
  updateDebitBatchItemStatus: (data) => sendRequest('updateDebitBatchItemStatus', data, 'POST'),
  deleteDebitBatch: (maDot) => sendRequest('deleteDebitBatch', { maDot }, 'POST'),
