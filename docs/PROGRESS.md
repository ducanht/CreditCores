...
| **18/09/2026** | **v1.5.1** | **Hoàn thành Nghiên cứu & Đặc tả Thiết kế lại CSDL Tối ưu hóa Hiệu năng (Data Mart / Read-Optimized Schema): Đặc tả chi tiết mô hình Self-Contained Loan Record cho `HDTD_CORE`, Unified Customer Profile cho `KH_CORE`, Bảng Snapshot Điều Hành 16 dòng `DASHBOARD_SNAPSHOT`, và 8 nội dung nghiệp vụ chuyển giao cho Python Daemon xử lý trước khi đẩy lên Google Sheets (Chuẩn hóa Thôn/Xã, phân nhóm sản phẩm, tính sẵn dư nợ KH 360, sinh bảng báo cáo)** |
